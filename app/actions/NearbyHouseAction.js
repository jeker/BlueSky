...
export let nearbyHouseAction = (isNoData,isLoadMore, isRefreshing, isLoading, page) => {
    ...
    return dispatch => {
        dispatch(feachHouseList(isNoData,isLoadMore, isRefreshing, isLoading));
...
let feachHouseList = (isNoData, isLoadMore, isRefreshing, isLoading) => {
    return {
